...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, GlobalAveragePooling2D, Dropout, Dense, Input, Flatten
...
class GrapeDiseaseClassifier:
    ...
    def train_model(self, epochs=50, batch_size=32, learning_rate=1e-4):
        ...
        history = model.fit(
            ...
            epochs=epochs,
            validation_data=(X_test / 255.0, y_test),  # 确保验证数据归一化
...
if __name__ == "__main__":
    ...
    model_path = "grape_disease_model_20240922_mobilenet_v2"
