...
try:
    from .model.src_mobilenet_v4_SE_BiFPN import MobileNetV4Pro
except:
    from model.src_mobilenet_v4_SE_BiFPN import MobileNetV4Pro
...
class GrapeDiseaseClassifier:
    def __init__(self, data_folder=None, model_path="mobilenetv4_SE_BiFPN.pth"):
...
#     model_path = "mobilenet_v4_SE_BiFPN.pth"
#
